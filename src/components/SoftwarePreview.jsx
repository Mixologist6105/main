...
const aimGroups = {
  ...
  Legit: [
    ...
    {
      key: 'Mouse_Smooth',
      label: '平滑度 / Smoothness',
      type: 'range',
      min: 0,
      max: 100,
      step: 1,
      unitText: '%',
      hint: 'AI 整体瞄准的平滑度都由此控制, 数值越大, 瞄准的越平滑, 但也会导致鼠标移动轨迹不平滑, 数值越小, 瞄准的越不平滑, 但也会导致鼠标移动轨迹平滑 / Controls overall aim smoothness. Higher values feel smoother but can reduce snap response.',
    }, 
  ],
  FOV: [
    {
...
const initialValues = {
  ...
  Network_Settings: { ip: '127.0.0.1', port: '6000' },
  Language: '简体中文',
  MouseMoveMethod: 'Makcu Box',
  ToggleKey: ['Mouse 5'],
  key1: ['Mouse Right'],
  TriggerBot: false,
  Trigger_Hitbox: { top: 0.35, width: 0.66, height: 0.22 },
  TriggerBotKey: ['Mouse Left'],
  First_Shot_Delay: 80,
  Trigger_Delay: 120,
  MouseMove_Pred: '-',
  Pred_Comp: 3,
